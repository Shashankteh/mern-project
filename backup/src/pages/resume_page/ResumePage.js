...
const resumeLink = "https://raw.githubusercontent.com/Shashankteh/cv/main/shashank.pdf";

function Resume() {
  const [width, setWidth] = useState(1200);
  const [pdfError, setPdfError] = useState(false); // To manage PDF loading errors
